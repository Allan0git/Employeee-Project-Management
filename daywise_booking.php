...
<body style="background-image:url(../Guest/images/account-bg.jpg)">
  <form action="" method="POST">
    ...
    <div class="container" style="width:120%;margin-bottom: 5%;padding-top:0%">
      <div class="col-md-12"
        style="box-shadow: 2px 2px 15px #1b93e1; border-radius:0px; top: 14px; margin-left:37px;background-color:blue">
  ...
  <form action="" method="POST">
    ...
    if (isset($_POST["btnsubmit"])) {
      ...
      <div class="col-md-12"
        style="box-shadow: 2px 2px 10px #1b93e1; border-radius:50px;margin-top:-15px;background-color:blue">
        <br>
        ...
        <div style="padding-bottom:4%">
          <table class="table table-hover"
            style="border: 2px solid #adaaaa;margin-left:4px; box-shadow: 3px 3px 11px #777777; padding-bottom:content;background-color:blue">
            ...
            $sql = "SELECT count(*) as count,empname,registrationdate FROM tbl_employee  where
registrationdate >='$fromdate' and registrationdate <='$todate' group by empid ";
            ...
            while ($display = mysqli_fetch_array($result)) {
              ...
              echo "<td>" . $display["empname"] . "</td>";
              echo "<td>" . $display["registrationdate"] . "</td>";
