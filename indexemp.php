		...
		<div class="container">
			<div class="row align-items-center justify-content-between pt-5">
				<div class="col-lg-6 text-center text-lg-start pe-lg-5">
					<h1 class="heading text-white mb-3" data-aos="fade-up">Hai , <?php echo $_SESSION['username'] ?></h1>
					<p class="text-white mb-5" data-aos="fade-up" data-aos-delay="100">Welcome To EMP.</p>
