...
<body>
<form action="Excel/excel_user.php" method="post">
<div class="logo">
              <a href="./index.php">
                <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  ...
  <h2 style="text-align: center;margin-top: 6%;font-family: fantasy;">EMPLOYEE LIST</h2>
...
$obj=new dboperation();
$sql="select * from tbl_employee f inner join tbl_login d on f.loginid=d.loginid where d.role='Employee' ";
